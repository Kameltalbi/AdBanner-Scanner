        ...
        <div class="adwptracker-ad <?php echo esc_attr(implode(' ', $device_classes)); ?>" 
            ...
            <?php elseif ($type === 'video' && $video_url): ?>
                ...
                if ($video_type === 'youtube') {
                    ...
                    if ($youtube_id) {
                        $embed = '<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%;"><iframe src="https://www.youtube.com/embed/' . esc_attr($youtube_id) . '?autoplay=1&mute=1&loop=1&playlist=' . esc_attr($youtube_id) . '&controls=0&showinfo=0&rel=0&modestbranding=1" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe></div>';
                    }
                } elseif ($video_type === 'vimeo') {
                    if (preg_match('/vimeo\.com\/(\d+)/', $video_url, $m)) {
                        $embed = '<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%;"><iframe src="https://player.vimeo.com/video/' . esc_attr($m[1]) . '?autoplay=1&loop=1&muted=1&background=1&controls=0" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" frameborder="0" allowfullscreen allow="autoplay; fullscreen; picture-in-picture"></iframe></div>';
                    }
